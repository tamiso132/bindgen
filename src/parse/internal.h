...
void s_parse_struct_from_string(const char *content, VecTStructInfo *structs);
void s_parse_defines_from_string(const char *content, VecTDefineInfo *define_info);
